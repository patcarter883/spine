...
def _build_plan_prompt(
    *,
    ...
    return (
        ...
        "- `search_codebase` — find files relevant to given topics/keywords. "
        "Use this to understand existing code before planning changes.\n"
        ...
        "Use `search_codebase` for all file discovery.\n\n"
        ...
        "```\n\n"
        "### Step 2 — Search codebase (1-2 turns)\n"
        "Call `search_codebase` with queries derived from the specification. "
        "Focus on: existing modules you'll modify, patterns to follow, "
        "integration points, and test file locations.\n\n"
        "Example:\n"
        "```json\n"
        '{"queries": ["WorkflowState", "submit_work", "UIApi"],\n'
        ' "file_patterns": ["spine/**/*.py"]}\n'
        "```\n\n"
        ...
        "- Every file path in the plan MUST come from `search_codebase` "
