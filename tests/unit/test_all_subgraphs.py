...
class TestParentGraphWithSubgraphs:
    ...
    def test_task_workflow_graph_compiles(self):
        ...
        assert "gate_critic_plan_to_implement" in nodes
        # All phases should be subgraph nodes now
        assert any(n.startswith("gate_") for n in nodes)

    def test_critical_task_workflow_graph_compiles(self):
        from spine.workflow.compose import build_workflow_graph
    ...
    def test_task_spec_workflow_graph_compiles(self):
        from spine.workflow.compose import build_workflow_graph
    ...
    def test_critical_task_spec_workflow_graph_compiles(self):
        from spine.workflow.compose import build_workflow_graph
...
class TestSubgraphStateMappers:
    ...
    def test_plan_state_mapper(self):
        ...
        parent = {"work_id": "def", "work_type": "task", "description": "d"}
    ...
    def test_plan_state_mapper_task(self):
        from spine.workflow.compose import _plan_state_mapper
